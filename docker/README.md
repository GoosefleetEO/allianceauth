...
1. run `bash <(curl -s https://gitlab.com/allianceauth/allianceauth/-/raw/v2.15.x/docker/scripts/download.sh)`. This will download all the files you need to install auth and place them in a directory named `aa-docker`. Feel free to rename/move this folder.
